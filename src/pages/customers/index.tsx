...
export function CustomerListPage(props: CustomerListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCustomers({
        relations: ['user', 'gym', 'trainer', 'booking.count'],
  ...
  const columns: ColumnType[] = [
    ...
    },
    {
      ...
      header: 'Preferred Workout Time',
      accessorKey: 'preferred_workout_time',
      cell: ({ row: { original: record } }: any) =>
        record?.preferred_workout_time
          ? format(parseISO(record?.preferred_workout_time as unknown as string), 'dd-MM-yyyy')
          : '',
    },
