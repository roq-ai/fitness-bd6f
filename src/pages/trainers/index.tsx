...
export function TrainerListPage(props: TrainerListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getTrainers({
        relations: ['user', 'gym', 'booking.count', 'customer.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['specialty.contains', 'certification.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'certification', header: 'Certification', accessorKey: 'certification' },
