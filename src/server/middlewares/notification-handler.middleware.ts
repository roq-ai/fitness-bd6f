...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'customer.update': {
    ...
    tenantPath: ['gym', 'customer'],
    userPath: [],
  },
  'booking.create': {
    roles: ['owner', 'team-member', 'trainer'],
    key: 'customer-new-booking',
    tenantPath: ['gym', 'booking'],
    userPath: [],
  },
  'booking.update': {
    roles: ['owner', 'team-member', 'trainer'],
    key: 'customer-update-booking',
    tenantPath: ['gym', 'booking'],
    userPath: [],
  },
  'booking.delete': {
    roles: ['owner', 'team-member', 'trainer'],
    key: 'customer-delete-booking',
    tenantPath: ['gym', 'booking'],
    userPath: [],
  },
  'gym.update': { roles: ['owner', 'team-member'], key: 'team-member-update-gym', tenantPath: ['gym'], userPath: [] },
  'trainer.update': {
    roles: ['owner', 'team-member'],
    key: 'trainer-update-profile',
    tenantPath: ['gym', 'trainer'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['owner', 'team-member', 'trainer'];
